...
(function($){
	...
	$.fn.Xslider=function(settings){
		...
		this.each(function(){
			var scrollobj=settings.scrollobj ? $(this).find(settings.scrollobj) : $(this).find("ul"),
			    ...
			    btnright=$(this).find("a.aright")?$(this).find("a.aright"):$(this).find("a.prev"),
			    btnleft=$(this).find("a.aleft")?$(this).find("a.aleft"):$(this).find("a.next");
			...
			if(settings.autoscroll){
				$.fn.Xslider.sn.autoscroll($(this),settings.autoscroll,settings.vane);
			}
		})
	}
	...
	$.fn.Xslider.sn={
		...
		autoscroll:function(obj,time,thisvane){
			//var  vane="right";
